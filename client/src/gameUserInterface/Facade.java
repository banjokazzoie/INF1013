...
public class Facade extends Observable implements Observer{
	...
	static NicknameActionListener nicknameActionListener = null;
	static Board board;
	...
	public static void newNicknameActionListener(){
		nicknameActionListener = new NicknameActionListener();
	}
	public static NicknameActionListener getNicknameActionListener (){
		return nicknameActionListener;
	}
