...
{	
	...
	public Board(char myColor)
	{
		...
		mine = myColor;
		System.out.println(line + " - Brancas Começam!");
		line++;
		...
		/* + 15 e + 40 são valores arbitrariamente escolhidos */
	...
	private void nextTurn ()
	{
		...
		{
			turn = 'p';
			System.out.println(line + " - Turno das Peças Pretas!");
		}
		else
		{	
			turn = 'b';
			System.out.println(line + " - Turno das Peças Brancas!");
		}
		line++;
	}
